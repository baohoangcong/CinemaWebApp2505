	...
	<div class="container mt-5">
		<div class="row" style="width: 1500px">
			...
			<div class="col-9 mt-5" align="center">
				...
				<form:form
					action="${pageContext.request.contextPath}/admin/themphim"
					...
					<table class="table">
						...
						<tr>
							<td class="col-1"><label>Poster<span class="rq">*</span>
									:
							</label></td>
							<td><button class="btn btn-info"
								...
								style="display: none;">
								<div id="mydiv" class="col-lg-4 col-sm-6 mb-4"></div></td>
							<td class="col-3"><div class="errors">${msg5}</div></td>
						</tr>
						<tr>
							<td></td>
							<td><form:button class="btn btn-success" type="submit">Thêm Phim</form:button></td>
						</tr>
					</table>
				</form:form>
			</div>
