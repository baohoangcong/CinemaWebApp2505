			...
			<div class="row">
					...
					<c:forEach var="c" items="${listPhim}">
						<div class="col-lg-4 col-sm-6 mb-4">
							...
							<div class="portfolio-item">
								<a class="portfolio-link" data-bs-toggle="modal" href="${pageContext.request.contextPath}/phimview/${c.maPhim}">
								...
								<div class="portfolio-caption">
									...
									<div class="portfolio-caption">
										<div class="portfolio-caption-heading">Đạo Diễn:
											${c.daoDien}</div>
									</div>
									<div class="portfolio-caption">
										<div class="portfolio-caption-heading">Thể Loại:
											${c.moTaPhim}</div>
									</div>
								</div>
							</div>
				...
				<div class="pagination">
					<c:if test="${currentPage > 1}">
						<a href="phimsapchieu?page=${currentPage-1}">Previous</a>
					</c:if>
					<c:forEach begin="1" end="${totalPages}" var="i">
						<c:choose>
							...
							<c:otherwise>
								<a href="phimsapchieu?page=${i}">${i}</a>
							</c:otherwise>
						</c:choose>
					</c:forEach>

					<c:if test="${currentPage lt totalPages}">
						<a href="phimsapchieu?page=${currentPage+1}">Next</a>
					</c:if>
				</div>
			</div>
		</div>
